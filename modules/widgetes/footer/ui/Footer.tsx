...
export default function Footer() {
  ...
  return (
    // <footer className="flex flex-col items-center justify-center gap-4 p-6 bg-white-800 text-white">
    ...
    //     </a>
    //   </div>
    //   <p className="text-sm text-gray-400">© 2025 My App. Все права защищены.</p>
    // </footer>
              ...
              <div className="flex flex-row mt-5 ">
                <Link href={'https://x.com/volkovkostia116'}
                  target="_blank"
                    rel="noopener noreferrer"
                >
                  <div className="rounded-full border p-5 border-foreground">
                    <X />
                  </div>
                </Link>
                <Link href={'https://www.instagram.com/_kostya.volkov/reels/'}
                  ...
                  rel="noopener noreferrer"
                >
                  <div className="ml-5 rounded-full border p-5 border-foreground">
                    <Instagram className="" />
                  </div>
                </Link>
